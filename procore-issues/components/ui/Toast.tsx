...
function Toast({ toast, onDismiss }: { toast: ToastMessage; onDismiss: (id: number) => void }) {
  ...
  return (
    <div className="pointer-events-auto flex w-80 animate-toast-in items-start gap-2.5 rounded-lg border border-border bg-ink px-4 py-3 text-white shadow-panel">
